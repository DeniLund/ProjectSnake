...
#include "ProjectSnake/SnakeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PROJECTSNAKE_API UEnum* Z_Construct_UEnum_ProjectSnake_EMovementDirection();
	UPackage* Z_Construct_UPackage__Script_ProjectSnake();
	PROJECTSNAKE_API UClass* Z_Construct_UClass_ASnakeBase_NoRegister();
	PROJECTSNAKE_API UClass* Z_Construct_UClass_ASnakeBase();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	PROJECTSNAKE_API UClass* Z_Construct_UClass_ASnakeElementBase_NoRegister();
...
// End Cross Module References
	static UEnum* EMovementDirection_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_ProjectSnake_EMovementDirection, Z_Construct_UPackage__Script_ProjectSnake(), TEXT("EMovementDirection"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMovementDirection(EMovementDirection_StaticEnum, TEXT("/Script/ProjectSnake"), TEXT("EMovementDirection"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_ProjectSnake_EMovementDirection_Hash() { return 3238582612U; }
	UEnum* Z_Construct_UEnum_ProjectSnake_EMovementDirection()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_ProjectSnake();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EMovementDirection"), 0, Get_Z_Construct_UEnum_ProjectSnake_EMovementDirection_Hash(), false);
#else
	...
	IMPLEMENT_CLASS(ASnakeBase, 2942773201);
	template<> PROJECTSNAKE_API UClass* StaticClass<ASnakeBase>()
	{
		return ASnakeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASnakeBase(Z_Construct_UClass_ASnakeBase, &ASnakeBase::StaticClass, TEXT("/Script/ProjectSnake"), TEXT("ASnakeBase"), false, nullptr, nullptr, nullptr);
